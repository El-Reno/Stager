...
namespace InjectTestTester
{
    class Program
    {
        ...
        {
            //Tester.Execute();
            Console.WriteLine(DirectoryTraversal.EnumerateDirectoryStructure(@"C:\Users\kylee", "TEXT"));
            //Console.WriteLine(DirectoryTraversal.EnumerateDirectoryStructure(@"C:\Users\kylee\Documents\NetBeansProjects", "XML"));
